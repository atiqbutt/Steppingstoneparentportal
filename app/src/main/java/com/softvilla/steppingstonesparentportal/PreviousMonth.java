...
public class PreviousMonth extends Fragment implements OnChartValueSelectedListener {
    ...
    public static final String LASTMONTH_URL = "http://www.steppingstones.edu.pk/edusol/Api/getLastMonthAttendance";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, LASTMONTH_URL,
