...
public class CurrentMonth extends Fragment implements OnChartValueSelectedListener {
    ...
    public static final String CURRENTMONTH_URL = "http://www.steppingstones.edu.pk/edusol/Api/getCurrentMonthAttendance";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dialog.setTitle("Current Month Attendance");
